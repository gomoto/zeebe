...
public final class Namespaces {
  ...
  public static final Namespace BASIC =
      new Builder()
          ...
          .register(new ArraysAsListSerializer(), Collections.emptyList().getClass())
          ...
          .register(new ByteBufferSerializer(), ByteBuffer.class)
          .register(new ByteBufferSerializer(), ByteBuffer.allocate(1).getClass())
          .register(new ByteBufferSerializer(), ByteBuffer.allocateDirect(1).getClass())
          .name("BASIC")
          .build();
